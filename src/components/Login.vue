  ...
  <div id="login">
    <v-app id="login">
      <v-dialog v-model="dialog" persistent max-width="600px" min-width="360px">
        <div>
          <v-tabs v-model="tab" show-arrows background-color="#FFA535BF" icons-and-text dark grow>
            ...
            ></v-text-field>
                      ...
                      <v-col cols="12">
                        <v-text-field v-model="password" :append-icon="show1 ? 'eye' : 'eye-off'"
            ...
            ></v-text-field>
                      ...
                      <v-col class="d-flex" cols="12" sm="3" xsm="12" align-end>
                        <v-btn x-large block :disabled="!isFormValid" color="orange" @click="loginFunc()"> Login </v-btn>
                      </v-col>
                    </v-row>
                  </v-form>
                </v-card-text>
